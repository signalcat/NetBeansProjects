...
IndexedMfamSpiPacketWithHeader myPacket;

//const char* PAYLOAD1 = (std::to_string(myPacket.dwRecordType)).c_str();
const char* PAYLOAD1 = "abcd efgh ijkl mnop qrst uvwx yzab cdef ghij";
